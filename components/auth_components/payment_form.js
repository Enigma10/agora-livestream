    ...
    render() {
        ...
        const makePayment = async () => {
            ...
            try {
                ...
                console.log(placeOrder.data.message);
                if(placeOrder.data.message === "Your order is placed. Check orders section.") {
                    alert("Order Placed!!!!");
                }
                else {
                    alert("Couldn't place Order!!!!  Something went wrong!!!");
                }
            }
            catch(err) {
                console.log(err)
